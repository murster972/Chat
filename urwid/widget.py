...
class Text(Widget):
    ...
    def get_text(self):
        ...
        :returns: (*text*, *display attributes*)
            ...
            *text*
              complete bytes/str content of text widget
    ...
    text = property(lambda self:self.get_text()[0], doc="""
        Read-only property returning the complete bytes/str content
        of this widget
        """)
...
class Edit(Text):
    ...
    def __init__(self, caption=u"", edit_text=u"", multiline=False,
        ...
        :param edit_text: initial text for editing, type (bytes or str)
    ...
    def set_edit_text(self, text):
        ...
        :param text: text for editing, type (bytes or str)
                     must match the text in the caption
    ...
    def insert_text(self, text):
        ...
        :param text: text for inserting, type (bytes or str)
                     must match the text in the caption
        :type text: bytes or str
    ...
    def keypress(self, size, key):
        ...
        if self.valid_char(key):
            if (isinstance(key, str) and not
                ...
                # screen is sending us str input, must be using utf-8
    ...
    def get_line_translation(self, maxcol, ta=None ):
        ...
        maxcol = maxcol if isinstance(maxcol, int) else maxcol[0]
        if x < 0:
            return ( trans[:y]
