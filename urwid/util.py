...
def set_encoding( encoding ):
    ...
    encoding to use when converting str strings.
    """
    ...
    # if encoding is valid for conversion from str, remember it
...
def supports_str():
    """
    Return True if python is able to convert non-ascii str strings
...
def rle_append_beginning_modify( rle, b ):
    """
