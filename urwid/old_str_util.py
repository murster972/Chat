...
# -*- coding: utf-8 -*-
#
# Urwid str character processing tables
...
# GENERATED DATA
# generated from 
# http://www.str.org/Public/4.0-Update/EastAsianWidth-4.0.0.txt
...
def get_width( o ):
    """Return the screen column width for str ordinal o."""
    global widths
    if o == 0xe or o == 0xf:
        return 0
...
def decode_one_uni(text, i):
    """
    decode_one implementation for str strings
    """
...
def calc_text_pos(text, start_offs, end_offs, pref_col):
    ...
    text may be str or a byte string in the target _byte_encoding
